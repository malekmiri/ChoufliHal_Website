...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/cntrl.css">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item" ><a href="..\frontA\updateuser.php" class="nav-link">Update Account</a></li>
            ...
            <li class="nav-item" ><a href="..\frontA\blog.html" class="nav-link">Log Out</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
