...
<div class="box-container">
      ...
      <?php
         ...
         $select_Rdv = $conn->prepare("SELECT * FROM `reservation` WHERE `rStatus` LIKE '%{$search_box}%' OR `mStatus` LIKE '%{$search_box}%'");
         $select_Rdv->execute();
      ...
      ?>
         ...
         <table class="table">
            ...
            <tr>
                <td><?php echo $fetch_Rdv['Id_rdv']; ?></td>
                <td><?php echo $fetch_Rdv['id_srv']; ?></td>
                <td><?php echo $fetch_Rdv['dateR']; ?></td>
                <td><?php echo $fetch_Rdv['dStart']; ?></td>
                <td><?php echo $fetch_Rdv['dEnd']; ?></td>
                <td><?php echo $fetch_Rdv['duree']; ?></td>
                <td><?php echo $fetch_Rdv['mStatus']; ?></td>
                <td><?php echo $fetch_Rdv['rStatus']; ?></td>
      ...
      <?php
            ...
            echo '<p class="empty">no such reservation is added yet!</p>';
         }
      }
      ...
      ?>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Table des Commandes</h6>
