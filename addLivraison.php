...
<head>
    ...
    <link rel="icon" href="images/chouflihal.png">
</head>
        ...
        <div class="container" data-scrollax-parent="true">
          <div class="row slider-text align-items-end">
            <div class="col-md-7 col-sm-12 ftco-animate mb-5">
              ...
              <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Confirmer Votre Livraison</h1>
            </div>
          </div>
        </div>
      </div>
...
>
    ...
    <tr>
        ...
        <tr>
            <td>
                <label for="Id Livreur">ID Livraison:
                </label>
            </td>
            <td><input type="text" name="IdLivreur" id="IdLivreur" maxlength="20"></td>
        </tr>
        <tr>
            <td>
                <label for="Destinataire">Nom Destinataire:
                </label>
            </td>
