      ...
      foreach ($Srv as $SrvS) {
        ?>
            <tr>
                ...
                <td> 
                    <a href="deleteSrv.php?id=<?php echo $SrvS['id_srv'];?>"><button class="btn btn-primary">Delete</button></a>  
                </td>

                <td> 
                <a type="submit" href="updateSrv.php?id=<?php echo $SrvS['id_srv']; ?>"><button class="btn btn-primary">Update</button></a>
                </td>

                <!-- <td>
                <form method="POST" action="updateSrv.php">
                <a type="submit" name="Modifier" ><button class="btn btn-primary">Update</button></a>
                <input type="hidden" value=<?php /*echo $SrvS['id_srv']; */?> name="id_srv">
                </form>
                </td> -->
