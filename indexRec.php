...
// echo "Number of traited claims: " . $countT . "<br>";
// echo "Number of non-traited claims: " . $countNT . "<br>";
...
$count = count($liste);
//echo "Total number of reclamations: " . $count;


// //AVRG TIME
$reclamation = new ReclamationC();
$avgTime = $reclamation->getAverageResolutionTime();
// echo "The average resolution time is: " . $avgTime . " seconds";
 //trie
 if(isset($_POST['Trie']))
 {  
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0">Chahed Loumi</h6>
                        <span>Admin</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    <a href="..\View\backA\userDash.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                   ...
                   <div class="nav-item dropdown" class="">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="table.php" class="dropdown-item">Liste produits</a>
                            <a href="listeReclamation.php" class="dropdown-item">Liste Recs</a>
                            <a href="ListeReponse.php" class="dropdown-item">Liste Reps</a>
                            <a href="..\BackE\Events.php.php" class="dropdown-item">Liste events</a>
                            <a href="..\BackE\table.php" class="dropdown-item">table</a>
                            <a href="listeReclamation.php" class="dropdown-item">Liste Recs</a>
        ...
        ?>     </thead>
           ...
           <!-- tableau -->
           <form action="updateReponse.php" method="Get">
           <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Dernieres Reponses</h6>
                         <!-- <a href="">Plus</a> -->
                    </div>
            <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    <th scope="col"><input class="form-check-input" type="checkbox"></th>
                                    <th scope="col">Date</th>
                                    <th scope="col">#ID_Reponses</th>
                                    <th scope="col">#ID_Reclamations</th> 
                                    <th scope="col">Objet</th>
                                </tr>
            ...
            foreach ($listeR as  $reponse){
        ?>
        <script src="verif.js" async></script>
        <tr>
        <td><input class="form-check-input" type="checkbox"></td>
        <td><?php echo $reponse['dateReponse'];?></td>
        <td><?php echo $reponse['idReponse'];?></td>
        <td><?php echo $reponse['idReclamation'];?></td>
        <td><?php echo $reponse['descriptionR'];?></td>""

                <td><a type="submit" href="updateReponse.php?idReponse=<?php echo $reponse['idReponse'];?>&idReclamation=<?php echo $reponse['idReclamation'];?>" class="btn btn-sm btn-primary">modifier</a></td>
                <td><a href="deleteReponse.php?idReponse=<?php echo $reponse['idReponse']; ?>" class="btn btn-sm btn-primary">supprimer</a></td>
                <td><a type="submit" href="ResolutionTime.php?idReponse=<?php echo $reponse['idReponse'];?>&idReclamation=<?php echo $reponse['idReclamation'];?>" class="btn btn-sm btn-primary">calculer</a></td>
                <td>
