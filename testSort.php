...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="container" data-scrollax-parent="true">
          <div class="row slider-text align-items-end">
            <div class="col-md-7 col-sm-12 ftco-animate mb-5">
              ...
              <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Liste de Vos Commandes</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <center >
    <form class="d-none d-md-flex ms-4" method="POST" action="testsort.php">
    ...
    <link rel="stylesheet" href="css/style1.css"> -->
        ...
        <h5 style="padding-top: 50px">
            <a  class="btn btn-primary" href="addCommande.php">Passer la Commande</a>
            <a  class="btn btn-primary" href="addLivraison.php">Demander une livraison</a>
...
<?php
   ...
   $select_Rdv = $conn->prepare("SELECT * FROM commande WHERE IdCommande LIKE '%{$search_box}%' ");
   $select_Rdv->execute();
   if($select_Rdv->rowCount() > 0){
      while($fetch_Rdv = $select_Rdv->fetch(PDO::FETCH_ASSOC)){
?>
   ...
   <table class="table">
      ...
      <tr>
          <td><?php echo $fetch_Rdv['IdCommande']; ?></td>
          <td><?php echo $fetch_Rdv['IdUser']; ?></td>
          <td><?php echo $fetch_Rdv['DateCommande']; ?></td>
...
<?php
      ...
      echo '<p class="empty">no such commande is added yet!</p>';
   }
}
