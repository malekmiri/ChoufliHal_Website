...
if (
    ...
    if (
        ...
        $CommandeC->addCommande($CommandeM);
        ...
        <div class="container" data-scrollax-parent="true">
          <div class="row slider-text align-items-end">
            <div class="col-md-7 col-sm-12 ftco-animate mb-5">
              ...
              <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Confirmer Votre Commande</h1>
            </div>
          </div>
        </div>
      </div>
...
<script>
    function validateForm() {
        ...
        let idLivreur = document.getElementById("IdUser").value;
        ...
        if (!/^[0-9]+$/.test(idLivreur)) {
            errorMessagesDiv.innerHTML = "ID should contain numbers only.";
            return false;
        }
