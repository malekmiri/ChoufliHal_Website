...
<div class="box-container">
      ...
      ?>
         ...
         <table class="table">
            ...
            <tr>
                <td><?php echo $fetch_Srv['id_srv']; ?></td>
                <td><?php echo $fetch_Srv['type']; ?></td>
                <td><?php echo $fetch_Srv['mode']; ?></td>
                <td><?php echo $fetch_Srv['freq']; ?></td>
                <td><?php echo $fetch_Srv['couts']; ?></td>
                <td><?php echo $fetch_Srv['description']; ?></td>
                <td> 
                </td>
